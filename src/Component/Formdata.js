    ...
    <div>
      <form onSubmit={handleSubmit} style={{width: '400px',padding: '20px',borderRadius:'5px',backgroundColor:'#f1f1f1'
        ...
        <div>
          ...
          marginBottom:'5px',fontWeight:'bold'}}>Address:</label>
          <input
            type="text"
            id="address"
            value={address}
        ...
        <div>
          ...
          marginBottom:'5px',fontWeight:'bold'}}>Education:</label>
          <input
            type="text"
            id="education"
            value={education}
        ...
        <div>
          ...
          marginBottom:'5px',fontWeight:'bold'}}>Phone:</label>
          <input
            type="text"
            id="phone"
            value={phone}
       ...
       padding:'10px',marginTop:'10px',backgroundColor:"#4caf50",
       color:'#fff',border:'none',borderRadius:'3px',cursor:'pointer'
      
      }}>Submit</button>
      </form>

      <button onClick={() => setShowTable(!showTable)} style={{display:'block',width:'30%',
       padding:'10px',marginTop:'10px',backgroundColor:"#4caf50",
       color:'#fff',border:'none',borderRadius:'3px',cursor:'pointer'
